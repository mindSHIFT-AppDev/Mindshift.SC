...
namespace Mindshift.SC.Common {
	public abstract class OpenDialogCommand : Command {
		protected void OpenDialog(string dialogName, Dictionary<string, string> parameters) { 
			...
			// TODO: parameters?
			Sitecore.Context.ClientPage.ClientResponse.ShowModalDialog(string.Format("/sitecore%20modules/Mindshift/Dialog/dialog.html?{0}#/dialog/{1}", queryString, dialogName), "1000", "600", "Select Version", false, "1000", "600", true);
		}
	}
}
